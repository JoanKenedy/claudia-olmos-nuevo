  ...
  return (
    ...
    >
      <iframe
        ...
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3763.8054938455025!2d-99.1799759895774!3d19.37757298181454!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85d1ff76373eb45d%3A0x5f74811dbf04fad8!2sDra%20Claudia%20Olmos%20Dentista!5e0!3m2!1ses-419!2smx!4v1726183376101!5m2!1ses-419!2smx"
        style={{ border: 0 }}
        allowFullScreen=""
        loading="lazy"
        referrerPolicy="no-referrer-when-downgrade"
      />
      <div className="container-map bg-primary rounded-xl py-7 px-4 my-5 text-white text-center flex justify-center items-center flex-col bg-actual md:shadow-gray-800 md:shadow-[-19px_3px_22px_-11px] md:h-[600px] md:max-w-[500px] md:p-8">
        ...
        <p className=" mb-6 font-semibold">
          Av. Insurgentes Sur 1188, Tlacoquemecatl del Valle, Benito Juárez,
        ...
        <a
          ...
          href="https://api.whatsapp.com/send?phone=525565095139"
          target="_blank"
