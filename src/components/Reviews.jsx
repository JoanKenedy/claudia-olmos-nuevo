...
export const Reviews = () => {
  const infoReview = [
    {
      name: "Tania García",
      textReview:
        "Este establecimiento ha sido de los mejores que he visitado. Ambos médicos profesionales, atentos y sobre todo con la mejor actitud de atender a sus pacientes.",
      imgSrc: paciente1,
    },
    {
      name: "Hector Pérez",
    ...
    },
    {
      ...
      textReview:
        "El mejor trabajo que me han realizado!!! Son super profesionales, limpios y sobre todo excelente servicio con precio accesible. Muy recomendado",
      imgSrc: paciente1,
    },
    {
      name: "Paola Julieta Rivera Velasco",
      textReview:
        "Súper profesionales, una atención excelente, muy puntuales y súper higiénicos, siempre muy atentos y te explican todo, con atención personalizada",
      imgSrc: paciente1,
    },
    {
  ...
  return (
    <section className="w-full flex justify-center items-center py-10 bg-actual lg:my-10">
